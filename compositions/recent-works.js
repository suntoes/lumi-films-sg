...
const works = [
  {
    title: '1 Shophouse Artwork',
    company: 'Talking Textiles',
    picSrc: 'images/asset-1.jpg',
    description:
      `Lumi Films is a film production company in Singapore. We strive not only create engaging content, but to also evoke emotions, share unique moments, and create memories through the craft of video.`
  },
  {
    title: '2 Shophouse Artwor',
    company: 'Talking Textiles',
    picSrc: 'images/asset-1.jpg',
    description:
      `Lumi Films is a film production company in Singapore. We strive not only create engaging content, but to also evoke emotions, share unique moments, and create memories through the craft of video.`
          ...
          <Box flex={1}>
            ...
            <AnimatePresence exitBeforeEnter mode="wait">
              ...
              <Heading as="h2" size={{ base: 'sm', md: 'md', lg: 'lg' }}>
                <p>
                  {works[index].title.split(" ").slice(0, works[index].title.split(" ").length - 1).join(" ")}{' '}
                  <span style={{ color: 'var(--chakra-colors-teal)' }}>
                    {works[index].title.split(" ")[works[index].title.split(" ").length - 1]}
                  </span>
                </p>
              </Heading>
